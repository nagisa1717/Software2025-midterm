...
WaterPrice = vendingMachine.waterPrice 
TeaPrice = vendingMachine.teaPrice
CokePrice = vendingMachine.cokePrice 
CoffeePrice = vendingMachine.coffeePrice
...
def test_buy_coffee():
    ...
    assert drink == "coffee"
    # --仕様に伴う変更--
    assert change == 150 + 50 - CoffeePrice
    assert vm1.payment == 0
    #----
